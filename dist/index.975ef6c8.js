...
var _catapiJs = require("./catapi.js");
const select = document.querySelector(`.breed-select`);
const loader = document.querySelector(`.loader`);
const error = document.querySelector(`.error`);
const info = document.querySelector(`.cat-info`);
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_6t0elxdjoziIG9cxE7fOyiyIhgPn5hu1qZhJ8DzemG6orAnpFLSFelUoTLGEFqmd";
...
(0, _catapiJs.fetchBreeds)().then((data)=>{
    ...
    (0, _notiflixDefault.default).Report.failure("Error", error1.textContent);
}).finally(()=>{
...
select.addEventListener("change", (ev)=>{
    ...
    (0, _catapiJs.fetchCatByBreed)(breed).then((response)=>{
        return response.data;
    }).then((cats)=>{
        info.style.display = `flex`;
        const array = cats.map((cat)=>`<div class="content"><img src="${cat.url}" class="cat-img"></img><div class="text-content"><h2 class="cat-name">${cat.breeds[0].name}</h2><p class="description">${cat.breeds[0].description}</p> <p><b>Temperament: </b>${cat.breeds[0].temperament}.</p></div></div>`);
      ...
      display: "";
      `;
        (0, _notiflixDefault.default).Report.failure("Error", error.textContent);
    }).finally(()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9d8U2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const fetchCatByBreed = (breed_id)=>{
    return (0, _axiosDefault.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${breed_id}`);
};
const fetchBreeds = ()=>{
    return (0, _axiosDefault.default).get("/breeds").then((response)=>{
        return response.data;
    });
};
